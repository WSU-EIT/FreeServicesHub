using FreeServicesHub.Client.Pages;
using FreeServicesHub.Components;
...
namespace FreeServicesHub
{
    public partial class Program
    {
        public static void Main(string[] args)
        {
            ...
            try { serverReferences.Add(typeof(FreeServicesHub.EFModels.EFModels.User).Assembly.Location); } catch { }
            ...
            try { serverReferences.Add(typeof(FreeServicesHub.Client.BlazorDataModel).Assembly.Location); } catch { }
            ...
            app.MapHub<freeserviceshubHub>("/freeserviceshubHub", signalRConnctionOptions => {
