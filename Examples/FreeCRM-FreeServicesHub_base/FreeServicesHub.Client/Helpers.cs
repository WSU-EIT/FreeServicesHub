...
using FreeServicesHub.Client.Pages.Settings.Tags;
// {{ModuleItemEnd:Tags}}
using FreeServicesHub.Client.Pages.Settings.Users;
using FreeServicesHub.Client.Shared;
using Humanizer;
...
public static partial class Helpers
{
    ...
    public static async Task EditUser(Guid UserId, Delegate? OnSaved = null, string width = "auto", string height = "auto")
    {
        ...
        await DialogService.OpenAsync<FreeServicesHub.Client.Pages.Settings.Users.EditUser>(title, parameters, new DialogOptions() {
